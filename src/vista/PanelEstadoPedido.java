 ...
 * @author Universidad
 */
public class PanelEstadoPedido extends javax.swing.JFrame {

    private final  String[] datos;
    
    public PanelEstadoPedido() {
    ...
    private void iniciarVentana(){
        ...
        this.setTitle("Estado de Pedidos");
        operacionesCrud("");
        selecionTabla(); 
    ...
    public EstadoPedido crearObjeto(){
        EstadoPedido estadoPedido = new EstadoPedido();
        try{
            
            estadoPedido.setId(Integer.parseInt(this.txtCrudCodigo.getText()));
            
            estadoPedido.setDescripcion(this.txtAreaCrudDescripcion.getText());
    ...
    public void cargarTabla(ArrayList<EstadoPedido> lista){
        ...
        Iterator <EstadoPedido> iterador = lista.iterator();
        
        while(iterador.hasNext()){
            EstadoPedido estadoPedido = iterador.next();
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(panelGeneral, javax.swing.GroupLayout.DEFAULT_SIZE, 403, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanelEstadoPedido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new PanelEstadoPedido().setVisible(true);
        });
    }
