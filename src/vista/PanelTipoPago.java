...
public class PanelTipoPago extends javax.swing.JFrame {
    ...
    private final  String[] datosTipoPago;
    
    public PanelTipoPago() {
        this.datosTipoPago = new String[2];
        initComponents();
        iniciarVentana();
    }
    ...
    private void iniciarVentana(){
        ...
        this.setTitle("Crud Tipo de pagos");
        operacionesCrud("");
        selecionTabla(); 
    ...
    public TipoPago crearObjetoProducto(){
        ...
        try{
            ...
            tipoPago.setId(Integer.parseInt(this.txtCrudCodigo.getText()));
            tipoPago.setDescripcion(this.txtCrudDescricion.getText());
    ...
    public void cargarTablaProductos(ArrayList<TipoPago> lista){
        ...
        if (dtmTipoPagos.getRowCount() != 0)
            {
              int d = dtmTipoPagos.getRowCount();
              for (int y = 0; y < d; y++)
                {
                  dtmTipoPagos.removeRow(0);
                }
            }
        this.jTableTipoPagos.setModel(dtmTipoPagos);
        
        Iterator <TipoPago> iterador = lista.iterator();
        
        while(iterador.hasNext()){
            TipoPago tipoPago = iterador.next();
            dtmTipoPagos.addRow(new Object[]
              {
              tipoPago.getId(),
    ...
    private void setearDatos(){
        this.txtCrudCodigo.setText(this.datosTipoPago[0]);
        this.txtCrudDescricion.setText(this.datosTipoPago[1]);
    ...
    private void initComponents() {
        ...
        jTableTipoPagos.setToolTipText("Productos existente en nuestro inventario");
            ...
            .addGroup(panelGeneralLayout.createSequentialGroup()
                ...
                .addGroup(panelGeneralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(panelGeneralLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jPanelCrud, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
