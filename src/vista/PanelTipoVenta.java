 ...
 * @author Universidad
 */
public class PanelTipoVenta extends javax.swing.JFrame {

    private final  String[] datosTipoVenta;
    
    public PanelTipoVenta() {
        this.datosTipoVenta = new String[2];
        initComponents();
        iniciarVentana();
    }
    ...
    public TipoVenta crearObjetoProducto(){
        TipoVenta tipoVenta = new TipoVenta();
        try{
            
            tipoVenta.setId(Integer.parseInt(this.txtCrudCodigo.getText()));
            tipoVenta.setDescripcion(this.txtCrudDescricion.getText());
    ...
    public void cargarTabla(ArrayList<TipoVenta> lista){
        
        DefaultTableModel dtmTipoVentas =(DefaultTableModel)this.jTableTipoPagos.getModel();
        // eliminar los datos que exinten en el modelo de la tabla antes de agregar los datos 
        if (dtmTipoVentas.getRowCount() != 0)
            {
              int d = dtmTipoVentas.getRowCount();
              for (int y = 0; y < d; y++)
                {
                  dtmTipoVentas.removeRow(0);
                }
            }
        this.jTableTipoPagos.setModel(dtmTipoVentas);
        
        Iterator <TipoVenta> iterador = lista.iterator();
        
        while(iterador.hasNext()){
            TipoVenta tipoVenta = iterador.next();
            dtmTipoVentas.addRow(new Object[]
              {
              tipoVenta.getId(),
              tipoVenta.getDescripcion(),
    ...
    private void selecionTabla(){
        ...
        this.jTableTipoPagos.getSelectionModel().addListSelectionListener((ListSelectionEvent e) -> {
           if (this.jTableTipoPagos.getSelectedRow()!= -1){
               ...
               for (int i = 0; i < 2; i++){
                   this.datosTipoVenta[i] = 
                           this.jTableTipoPagos.getValueAt(fila, i).toString();
               }
    ...
    public void operacionesCrud (String operacion){
        switch (operacion){
            ...
            case "Agregar" -> {
                ...
                this.txtCrudDescricion.setEnabled(true);
    ...
    private void setearDatos(){
        this.txtCrudCodigo.setText(this.datosTipoVenta[0]);
        this.txtCrudDescricion.setText(this.datosTipoVenta[1]);
    ...
    private void initComponents() {
        ...
        txtCrudDescricion = new javax.swing.JTextField();
        ...
        jTableTipoPagos.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jTableTipoPagos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jTableTipoPagos.setName("Inventario de zapatos"); // NOI18N
        jScrollPane2.setViewportView(jTableTipoPagos);
        if (jTableTipoPagos.getColumnModel().getColumnCount() > 0) {
            jTableTipoPagos.getColumnModel().getColumn(0).setResizable(false);
            jTableTipoPagos.getColumnModel().getColumn(1).setResizable(false);
        }
        ...
        txtCrudDescricion.setFont(new java.awt.Font("Aharoni", 0, 14)); // NOI18N
                ...
                .addGroup(jPanelCrudLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelCrudLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelCrudLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtCrudDescricion, javax.swing.GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)
        ...
        jPanelCrudLayout.setVerticalGroup(
            ...
            .addGroup(jPanelCrudLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanelCrudLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtCrudDescricion, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblCruddescripcion))
            ...
            .addGroup(panelGeneralLayout.createSequentialGroup()
                ...
                .addGroup(panelGeneralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(panelGeneralLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jPanelCrud, javax.swing.GroupLayout.DEFAULT_SIZE, 0, Short.MAX_VALUE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanelTipoVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new PanelTipoVenta().setVisible(true);
        });
    }
    ...
    private javax.swing.JTextField txtCrudDescricion;
